...
var _doctor = require("../resources/doctor/doctor.model");
...
const signup = async (req, res) => {
  ...
  try {
    const user = await _doctor.Doctor.create(req.body);
...
const signin = async (req, res) => {
  ...
  try {
    const user = await _doctor.Doctor.findOne({
...
const protect = async (req, res, next) => {
  ...
  const user = await _doctor.Doctor.findById(payload.id).select('-password').lean().exec();
